			...
			<div className="flex-1 flex flex-col">
				...
				{/* <div className="p-4 border-b flex items-center justify-between">
					<div className="flex items-center gap-2">
						<Avatar>
							<AvatarImage src={DummyPic} alt="Florencio" />
							<AvatarFallback>FD</AvatarFallback>
						</Avatar>
						<div>
							<div className="font-medium">Florencio Dorrance</div>
				...
				<ScrollArea className="flex-1 p-4">
					<div className="space-y-4">
						...
						<div className="flex gap-3">
							<Avatar>
								<AvatarImage src={DummyPic} alt="User" />
							...
							<div className="flex-1">
								...
								<span className="text-xs text-gray-500 mt-1">05:45 Pm</span>
							</div>
						</div>
						...
						{messages.map((msg) => (
							...
							>
								<Avatar className="flex-shrink-0">
									<AvatarImage
										src={msg.sender === "user" ? DummyPic1 : DummyPic}
